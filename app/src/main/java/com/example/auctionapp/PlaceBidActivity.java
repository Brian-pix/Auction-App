...
public class PlaceBidActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=findViewById(R.id.directMessage);
        ...
        btn_placeBid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bid.isEmpty()) {
                    ...
                    progressDialog.setMessage("Placing your bid");
    ...
    private void openChattingSection() {
        Intent i= new Intent(PlaceBidActivity.this,ChatActivity.class);
        startActivity(i);
    }
